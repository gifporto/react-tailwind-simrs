                    ...
                    >
                        {[
                            ...
                            <Label
                                key={item.id}
                                htmlFor={item.id}
                                className={`flex items-center gap-4 p-3 border rounded-lg transition-colors ${editable ? "cursor-pointer hover:bg-slate-50" : "cursor-not-allowed opacity-70"
                    ...
                    >
                        {[
                            ...
                            <Label
                                key={item.id}
                                htmlFor={item.id}
                                className={`flex flex-col items-center text-center p-3 border rounded-lg transition-colors ${editable ? "cursor-pointer hover:bg-slate-50" : "cursor-not-allowed opacity-70"
