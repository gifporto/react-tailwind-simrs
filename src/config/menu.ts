...
export const mainMenus: MenuItem[] = [
...

  {
    ...
    children: [
      { title: "Daftar Resep", url: "/farmasi/resep", module: "farmasi_resep" },
      {
        title: "Resep Klinik",
        url: "/farmasi/klinik",
        module: "farmasi_klinik",
      },
      {
        title: "Penjualan Langsung (OTC)",
        url: "/farmasi/penjualan",
        module: "farmasi_penjualan",
      },
...

  {
    ...
    children: [
      ...
      {
        title: "Neraca Harian",
        url: "/keuangan/neraca/harian",
        module: "keuangan_neraca_harian",
      },
      {
        title: "Neraca Bulanan",
        url: "/keuangan/neraca/bulanan",
        module: "keuangan_neraca_bulanan",
      },
      {
        title: "Neraca Tahunan",
        url: "/keuangan/neraca/tahunan",
        module: "keuangan_neraca_tahunan",
      },
      {
        title: "Daftar Pembiayaan",
        url: "/keuangan/pembiayaan",
        module: "keuangan_pembiayaan",
      },
      {
        title: "Input Pembiayaan",
        url: "/keuangan/pembiayaan/create",
        module: "keuangan_pembiayaan_create",
      },
      {
        title: "Rekap Pembiayaan",
        url: "/keuangan/pembiayaan/rekap",
        module: "keuangan_pembiayaan_rekap",
      },
    ],
  },
...

  {
    ...
    children: [
      ...
      {
        title: "Pernyataan Perpanjang Kontrak",
        url: "/sdi_surat_kontrak",
        module: "sdi_surat_kontrak",
      },
...

  {
    ...
    title: "Klaim BPJS",
    module: "klaim_bpjs",
    children: [{ title: "New Klaim", url: "/new_klaim", module: "new_klaim" }],
  },

  {
    ...
    children: [
      ...
      { title: "Obat", url: "/master/obat", module: "adm_obat" },
      {
        ...
        url: "/master/kelompok-tarif",
        module: "adm_komp_tarif",
      },
      {
        title: "Komponen Tarif",
        url: "/master/komponen-tarif",
        module: "adm_komp_tarif",
      },
      { title: "Dokter", url: "/master/dokter", module: "adm_dokter" },
      {
        title: "Tipe Pasien",
        url: "/master/tipe-pasien",
        module: "adm_tipe_pasien",
      },
      ...
      { title: "Kamar", url: "/master/kamar", module: "adm_kamar" },
      {
        ...
        module: "adm_tempat_tidur",
      },
      {
        title: "Penggunaan Tempat Tidur",
        url: "/master/penggunaan-tempat-tidur",
        module: "adm_penggunaan_tempat_tidur",
      },
      {
        title: "Lab Kategori",
        url: "/master/lab-kategori",
        module: "lab_kategori",
      },
      { title: "Lab Paket", url: "/lab/paket", module: "lab_paket" },
      { title: "Lab Service", url: "/lab/service", module: "lab_service" },
      {
        title: "Lab Service Item",
        url: "/lab/service-item",
        module: "lab_service_item",
      },
    ],
  },
